...
import courses.model.NotFoundException;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //tells the program where to look for static files(ex. css)
        staticFileLocation("/public");

        /*
        data access object for the courses
        array list of course ideas
        */
        CourseIdeaDAO dao = new SimpleCourseIdeaDAO();

        /*
        sets the username attribute so that we are not using cookies for the user auth.
        attributes are only seen server side and not by any users on the site
        */
        before((req, res)->{
        ...
        //when signed it this redirects to the home page
        ...
        //creates and brings us to the ideas page
        get("/ideas", (req, res) -> {
        ...
        //when a new idea is entered, redirects back to the same page (refresh)
        post("/ideas", (req, res)-> {
